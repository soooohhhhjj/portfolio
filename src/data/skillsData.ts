import type { SkillsContentState } from '../types/skills';
  ...
  cards: [
    {
      ...
      layout: { x: 76, y: 112, width: 462, height: 220 },
    },
    {
      id: 'backend',
      title: 'Backend',
      ...
      layout: { x: 578, y: 98, width: 293, height: 220 },
    },
    {
      id: 'database',
      title: 'Database',
      ...
      layout: { x: 59, y: 371, width: 298, height: 220 },
    },
    {
      id: 'tools',
      title: 'Tools',
      ...
      layout: { x: 396, y: 358, width: 462, height: 220 },
    },
  ],
  mdLayout: {
    cards: [
      { id: 'frontend', layout: { x: 18, y: 102, width: 420, height: 220 } },
      { id: 'backend', layout: { x: 461, y: 132, width: 260, height: 220 } },
      { id: 'database', layout: { x: 37, y: 346, width: 260, height: 220 } },
      { id: 'tools', layout: { x: 322, y: 376, width: 420, height: 220 } },
    ],
  },
  titleLayout: { x: 225, y: 13 },
};
